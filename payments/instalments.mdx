...
1. Go to your [financial dashboard](/payments/reporting) and open the **Instalments** tab.
...
- You have the **Financial Dashboard** [permission](/staff/permissions).
...
<AccordionGroup>
  ...
  <Accordion title="The booking was cancelled but the instalment plan is still running">
    Open the **Instalments** tab in the [financial dashboard](/payments/reporting), select the plan, and click **Terminate Instalment Plan**. This button appears whenever the base booking items have been cancelled but the plan is still in progress. See [From the financial dashboard](#from-the-financial-dashboard).
  </Accordion>

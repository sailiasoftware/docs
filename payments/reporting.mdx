...
You can export transaction data as CSV files from the financial dashboard. Exports are available for:

### Donation exports

Export donation records for charity reporting or Gift Aid claims. The CSV includes donation amounts, charity details, Gift Aid status, and donor information. See [donation exports](/payments/donations#exporting-donations) for full details on available columns.

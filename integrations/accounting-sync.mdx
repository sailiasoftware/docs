...
<Steps>
  ...
  <Step title="Assign categories to products">
    Assign accounting categories to your products — sessions, shop products, membership plans, activity passes, and add-ons. This determines how each sale is categorized on the Xero invoice.

...
Bookings from Adventuro appear alongside your online and POS bookings in the [bookings dashboard](/booking-and-sales/managing-bookings). Capacity is shared, so a booking through Adventuro reduces available spots for all channels.
...
| **Waiver questions** | Sailia → Adventuro | Any [waiver](/booking-and-sales/waivers) fields linked to an activity |
...
5. The booking appears in your [bookings dashboard](/booking-and-sales/managing-bookings) with an **Adventuro** payment reference.

...
<Note>
  Adventuro uses the [Core OTA API](/api-reference/ota-core) under the hood. If you are building a custom OTA integration, refer to the Core OTA endpoints directly.
</Note>

...
<AccordionGroup>
  ...
  <Accordion title="Tracking events not firing">
    ...
    3. Test by completing a booking on your [booking page](/getting-started/booking-page) and checking your analytics tool for `booking_start` and `booking_completed` events.

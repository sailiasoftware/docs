...
<Tip>
  Your [admin dashboard](/getting-started/admin-dashboard) includes an interactive setup checklist that tracks your progress through these steps automatically. Open it to see which steps you have completed and which are still outstanding.
</Tip>

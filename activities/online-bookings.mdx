...
1. The customer receives a confirmation email with booking details, a PDF receipt, and a [calendar invite](/customers/notifications#calendar-invites) (`.ics`) attachment.
...
When a guest (a customer without an account) completes a purchase, the payment success page displays a **Send receipt** button. Clicking it opens a popup where the guest can enter an email address to receive a copy of their booking confirmation, PDF receipt, and [calendar invite](/customers/notifications#calendar-invites).

...
Type the customer's email address into the search field. Matching accounts appear as you type, showing the email and name. Select an account to link it to the current order.

...
<Columns cols={2}>
  ...
  <Card title="Key concepts" icon="book" href="/getting-started/key-concepts">
    Definitions of the core terms used throughout Sailia.
  </Card>
...
<Columns cols={2}>
  ...
  <Card title="Troubleshooting" icon="wrench" href="/getting-started/troubleshooting">
    Solutions for common issues with bookings, payments, and more.
  </Card>
  <Card title="Data privacy and security" icon="shield-halved" href="/getting-started/data-privacy">
    How Sailia handles customer data and payment security.
  </Card>

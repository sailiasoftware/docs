...
<Columns cols={2}>
  ...
  <Card title="Admin dashboard" icon="chart-mixed" href="/getting-started/admin-dashboard">
    Track site traffic, monitor visitor metrics, and follow your setup checklist.
  </Card>
  ...
  <Card title="Branding and appearance" icon="paintbrush" href="/getting-started/branding">
...
<Columns cols={2}>
  ...
  <Card title="Importing customers" icon="file-import" href="/customers/importing-customers">
...
<Columns cols={2}>
  ...
  <Card title="Data and privacy" icon="shield-halved" href="/help/data-privacy">

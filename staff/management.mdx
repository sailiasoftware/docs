...
You can track instructor certifications and competencies by assigning [qualifications](/settings/qualifications) to staff members. Define qualification types in settings, then assign them to individual staff profiles.
...
<Columns cols={2}>
  ...
  <Card title="Qualifications" icon="certificate" href="/settings/qualifications">
    Define instructor certifications and competencies.
  </Card>

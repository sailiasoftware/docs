...
Shop products are items you sell alongside your activities — things like merchandise, equipment, food, and digital downloads. They can be purchased through your online booking page or the [point of sale](/booking-and-sales/point-of-sale).
...
<Steps>
  ...
  <Step title="Enable custom pricing (optional)">
    If the price varies (for example, items sold by weight), toggle on [custom pricing](/booking-and-sales/custom-pricing). POS operators enter the price manually when adding the item to a basket.
  </Step>
...
[Discount codes](/booking-and-sales/discount-codes) can be configured to apply to shop products. When creating a discount, enable **Shop products** under product eligibility and optionally restrict to specific items.

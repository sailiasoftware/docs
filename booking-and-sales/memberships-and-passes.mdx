...
<Steps>
  ...
  <Step title="Add benefits">
    Define what members receive. This typically includes a [membership discount](/booking-and-sales/discount-codes#membership-discounts) that auto-applies at checkout.
  </Step>
  <Step title="Publish">
...
When you link a [discount code](/booking-and-sales/discount-codes#membership-discounts) to a membership, it is automatically applied whenever the member checks out. Membership discounts are always auto-applied and stackable, so members can combine their membership benefit with other promotional codes.
...
Both memberships and activity passes are eligible for [discount codes](/booking-and-sales/discount-codes). When creating a discount, enable **Memberships** or **Activity passes** under product eligibility to allow the discount to apply.

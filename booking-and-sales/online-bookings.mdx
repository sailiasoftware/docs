...
<Steps>
  ...
  <Step title="Customer adds details">
    They enter attendee information, select any [add-ons](/booking-and-sales/activities#add-ons), and complete any required [waivers](/booking-and-sales/waivers).
  </Step>
...
All bookings — whether made online or through the [POS](/booking-and-sales/point-of-sale) — appear in your bookings dashboard. From here you can:
...
- [Shop products](/booking-and-sales/shop-products)
- [Activity passes](/booking-and-sales/memberships-and-passes)
- [Memberships](/booking-and-sales/memberships-and-passes)
- Add-ons

Customers can apply [discount codes](/booking-and-sales/discount-codes) at checkout. If a discount is set to [auto-apply](/booking-and-sales/discount-codes#create-a-discount-code), it is added automatically without entering a code.

<Note>
  [Gift cards](/booking-and-sales/gift-cards) can also be redeemed at checkout to cover part or all of the order total.
</Note>

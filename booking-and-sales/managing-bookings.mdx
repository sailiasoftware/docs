...
All bookings — whether made online, through the [point of sale](/booking-and-sales/point-of-sale), via the [Adventuro](/integrations/adventuro) marketplace, or the API — flow into a single bookings dashboard. From here you can track every reservation, update attendee details, process cancellations, and monitor payment status.
...
| **Waivers** | Completion status of any required [waivers](/booking-and-sales/waivers) |
| **Discount** | Any [discount codes](/booking-and-sales/discount-codes) or [membership discounts](/booking-and-sales/memberships-and-passes) applied |
...
Cancelled bookings free up the session capacity immediately. If a [waitlist](/booking-and-sales/waitlists) exists for the session, the next customer is notified automatically.
...
| Source | Description |
| --- | --- |
| **Online** | Booked through your [online booking page](/booking-and-sales/online-bookings) |
| **POS** | Created through the [point of sale](/booking-and-sales/point-of-sale) |

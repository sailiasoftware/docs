...
| **Process payments** | Take card payments through a [card reader](/booking-and-sales/card-readers), record cash, or send a payment link by email |
...
To connect a physical Stripe card reader to your terminal, see the [card readers](/booking-and-sales/card-readers) guide.
...
| Method | How it works |
| --- | --- |
| **Card** | Charges the customer through a connected Stripe [card reader](/booking-and-sales/card-readers). The payment is processed in real time and appears in your Stripe dashboard. |
...
<Columns cols={2}>
  <Card title="Card readers" icon="credit-card" href="/booking-and-sales/card-readers">

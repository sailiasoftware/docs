...
keywords: ['meter tracking', 'usage tracking', 'metered billing', 'API usage', 'consumption']
---
...
| `campaign-email-sent` | Recipients are queued for a [marketing campaign](/customers/campaigns) send | `campaignID`, `campaignUUID`, `campaignName` — identifiers and the campaign's internal name |

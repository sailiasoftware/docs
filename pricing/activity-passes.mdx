...
Use **Add Redemptions** to increase the number of remaining redemptions on a pass. This is useful when you need to:

- Correct a mistake where too many redemptions were deducted
- Grant bonus sessions as a goodwill gesture
- Extend a pass that was partially used due to cancellations

Enter the number of redemptions to add and select **Save**. The pass balance updates immediately.

### Deduct redemptions

Use **Deduct Redemptions** to manually reduce the number of remaining redemptions. You cannot deduct more than the current remaining balance.

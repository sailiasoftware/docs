...
| **Gift card delivery** | When a customer purchases a [gift card](/booking-and-sales/gift-cards) — sent to the buyer or recipient |
| **Waitlist notification** | When a spot opens up on a [waitlisted](/booking-and-sales/waitlists) session |
| **Membership renewal** | When a [membership](/booking-and-sales/memberships-and-passes) payment is processed or fails |
...
- **Waiver reminders** — remind customers to complete their [waiver](/booking-and-sales/waivers) before the activity
...
| `waitlist-notified` | [Waitlist](/booking-and-sales/waitlists) notification emails |

Use the meter usage API to monitor email volume and ensure your workflows are performing as expected.

## Resending emails

You can resend booking confirmation emails from the [booking details](/booking-and-sales/managing-bookings) at any time. This is useful when:

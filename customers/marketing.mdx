...
If a previously unsubscribed contact is added to your audience again, they are automatically resubscribed. This can happen when:

- The contact is **re-imported** through a CSV upload

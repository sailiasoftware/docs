...
- **Check activity passes** — see remaining redemptions on their [activity passes](/pricing/activity-passes) from the **Activity Passes** tab
...
<Note>
  The [notes section](/customers/overview#notes) on a customer profile is only visible to staff with the appropriate permissions. Customers cannot see internal notes.
</Note>

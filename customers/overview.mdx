...
- **Check membership status** to see if a customer has an active [membership](/booking-and-sales/memberships-and-passes) or [activity pass](/booking-and-sales/memberships-and-passes#activity-passes)
- **View waiver status** to confirm whether required [waivers](/booking-and-sales/waivers) have been completed
...
| **Memberships** | Any active [membership plans](/booking-and-sales/memberships-and-passes) |
| **Activity passes** | Any active [prepaid passes](/booking-and-sales/memberships-and-passes#activity-passes) with remaining sessions |
| **Gift card balance** | Any [gift cards](/booking-and-sales/gift-cards) linked to the account |
| **Waivers** | Completed and pending [waivers](/booking-and-sales/waivers) |
| **Profile image** | An optional photo uploaded by the customer — see [file uploads](/booking-and-sales/file-uploads) |
...
- Upload a [profile image](/booking-and-sales/file-uploads#profile-images)
...
When processing a [POS sale](/booking-and-sales/point-of-sale), you can link the transaction to an existing customer account. This ensures the booking appears in their history and any [membership discounts](/booking-and-sales/discount-codes#membership-discounts) are applied automatically.
